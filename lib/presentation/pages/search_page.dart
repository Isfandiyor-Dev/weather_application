            ...
            ScaffoldMessenger.of(context)
              ...
              ..showSnackBar(
                const SnackBar(
                  ...
                  content:
                      Text("Location data is not available. Please try again."),
                ),
              );
          }
        },
          ...
          children: [
            ...
            BlocBuilder<WeatherBloc, WeatherState>(
              builder: (context, state) {
                ...
                } else if (state is WeatherLoadedSearchState) {
                  final forecast = state.searchForecast;

                  if (forecast == null) {
                    return const Center(
                        child: Text("Weather forecast data is not available."));
                  } else {
                        ...
                        child: ListTile(
                          ...
                          trailing:
                            ...
                            builder: (context, favorites) {
                              ...
                              bool isFavorite = favorites.any((element) =>
                                  (element.lat == forecast.lat) &&
                                  (element.lon == forecast.lon));
                              return IconButton(
                                onPressed: () {
                                  if (isFavorite) {
                                    context
                          ...
                          onTap: () {
                            ...
                            Navigator.pushAndRemoveUntil(
                              ...
                              MaterialPageRoute(
                                  builder: (context) =>
                                      HomePage(forecastEntity: forecast)),
